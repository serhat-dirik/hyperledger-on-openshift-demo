...
image::02-cm-dashboard.png[Course Manager Dashboard,width=100%]
...
image::02-cm-issue-form.png[Issue Certificate Form,width=100%]
...
image::02-cm-cert-list.png[Certificate List,width=100%]

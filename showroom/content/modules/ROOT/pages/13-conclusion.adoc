...
* Use the xref:14-fabric-cheatsheet.adoc[Fabric Operations Cheatsheet] for quick-reference commands to inspect and troubleshoot the network
...
* Clone the https://github.com/serhat-dirik/hyperledger-on-openshift-demo[public GitHub repository^] to run this demo on your own OpenShift cluster

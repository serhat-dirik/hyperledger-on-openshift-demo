...
[source,bash,subs="attributes"]
----
oc logs deployment/orderer0 -n {central_namespace} --tail=20
----
...
[source,bash,subs="attributes"]
----
oc logs deployment/orderer -n {central_namespace}-techpulse --tail=20
----
...
[source,bash,subs="attributes"]
----
oc logs deployment/certcontract -n {central_namespace}-techpulse --tail=20
----

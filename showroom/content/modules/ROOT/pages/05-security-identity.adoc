...
[source,bash,subs="attributes"]
----
curl -sk "{verify_api_url}/api/v1/verify/$SEC_CERT_ID" | python3 -m json.tool
----
...
curl -sk "{verify_api_url}/api/v1/verify/$SEC_CERT_ID" | python3 -c "import sys,json; d=json.load(sys.stdin); print(f'$SEC_CERT_ID: {d[\"status\"]}')"

...
[source,text]
----
Committed block [54] ... channel=certchannel
----
...
[
    ...
    "certchannel_lscc",
    "certchannel_lifecycle",
    "certchannel_lifecycle$$h_implicit_org_DataForgeMSP",
    "certchannel_lifecycle$$h_implicit_org_NeuralPathMSP",
    "certchannel_lifecycle$$h_implicit_org_TechPulseMSP",
    "certchannel_lifecycle$$p_implicit_org_TechPulseMSP"
]
----
...
----
        ...
        Subject: C=US, ST=North Carolina, O=Hyperledger, OU=admin, CN=admin-techpulse
----
...
----
            Not After : Mar 17 04:44:00 2027 GMT
        Subject: C=US, ST=North Carolina, O=Hyperledger, OU=peer, CN=peer0-techpulse
                DNS:peer0, DNS:peer0.certchain-techpulse.svc.cluster.local, DNS:peer0-certchain-techpulse.apps...
----
...
[source,bash,subs="attributes"]
----
oc get secret orderer0-tls -n $CENTRAL -o jsonpath='{.data.server\.crt}' \
  | base64 -d | openssl x509 -text -noout 2>/dev/null \
  | grep -E "Subject:|DNS:|Not After"
----
...
----
        ...
        Subject: C=US, ST=North Carolina, O=Hyperledger, OU=orderer, CN=orderer0
                DNS:orderer0, DNS:orderer0.certchain.svc.cluster.local, DNS:orderer0-certchain.apps...
----
